...
- [x] Slice 3: Job Lifecycle Ergonomics & Terminal Auto-Rotation (Spec: `docs/specs/job-lifecycle-and-terminal-rotation.md`)
  ...
  - [x] Leaf 3: Implement Environment-Scoped Job Isolation (`REACTIVE_JOB_ID`). (Engine: `/tdd`, Gate: `gates/leaf-3-env-job-isolation.md`)
