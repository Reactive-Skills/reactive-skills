  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'text', text: 'The core runtime includes the TypeSafe SDK needed for semantic judgments, but only makes network calls when TYPESAFE_API_KEY is configured. Transitions declare domain-level semantic contracts (predicate, categorical, or evaluation) which the runtime delegates to registered Judgment Adapters:' },
        { type: 'list', items: [
