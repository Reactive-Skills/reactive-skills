...
> 🚀 **What's New in v0.4.1:** Flexible argument ordering for `jobs` (`jobs list <skill>` & `jobs <skill> list`), MCP job management tools, and template-level `jobId` exposure. [Read Full Release Notes →](https://github.com/Reactive-Skills/reactive-skills/releases/tag/v0.4.1) · [View Changelog](https://github.com/Reactive-Skills/reactive-skills/blob/main/CHANGELOG.md)
